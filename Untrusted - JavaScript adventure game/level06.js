...
function startLevel(map) {
    ...
    map.placeObject(map.getWidth()-2, 13, 'block');
  	...
  	map.placeObject(map.getWidth()-20, 13, 'block');
	  map.placeObject(map.getWidth()-20, 12, 'block');
	  map.placeObject(map.getWidth()-20, 11, 'block');
	  map.placeObject(map.getWidth()-19, 13, 'block');
	  map.placeObject(map.getWidth()-19, 11, 'block');
}
